...
Лицензия: MIT (см. COPYING.txt, http://ru.wikipedia.org/wiki/Лицензия_MIT)
...
BeQt рассчитан на использование совместно с Qt 5.
Поддержка версий Qt ниже 5.0.0 не гарантируется.

Примечание: для использования всех возможностей BeQt потребуются
следующие модули Qt: QtCore, QtNetwork, QtGui, QtWidgets.
...
Не забудьте скопировать эти файлы в свой проект.

Примечание: Файлы переводов не встраиваются в бибиотеки при использовании
параметра "beqt_builtin_resources", т.к. они могут занимать лишнее место.
Включайте их в свой проект вручную.
