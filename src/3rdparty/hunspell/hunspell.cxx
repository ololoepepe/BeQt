...
//BeQt patch ----------------------------------------------------------------------------------------------------------
Hunspell::Hunspell(const char *affpath, const char *dpath, const char *key, bool apathIsData, bool dpathIsData)
//BeQt patch end ------------------------------------------------------------------------------------------------------
{
//BeQt patch ----------------------------------------------------------------------------------------------------------
    mapathIsData = apathIsData;
    mdpathIsData = dpathIsData;
//BeQt patch end ------------------------------------------------------------------------------------------------------
    encoding = NULL;
    csconv = NULL;
    utf8 = 0;
...
//BeQt patch ----------------------------------------------------------------------------------------------------------
    pHMgr[0] = new HashMgr(dpath, affpath, key, dpathIsData, apathIsData);
//BeQt patch end ------------------------------------------------------------------------------------------------------
    if (pHMgr[0]) maxdic = 1;
...
//BeQt patch ----------------------------------------------------------------------------------------------------------
    pAMgr = new AffixMgr(affpath, pHMgr, &maxdic, key, apathIsData);
//BeQt patch end ------------------------------------------------------------------------------------------------------
...
//BeQt patch ----------------------------------------------------------------------------------------------------------
int Hunspell::add_dic(const char * dpath, const char * key, bool dpathIsData) {
//BeQt patch end ------------------------------------------------------------------------------------------------------
    if (maxdic == MAXDIC || !affixpath) return 1;
//BeQt patch ----------------------------------------------------------------------------------------------------------
    pHMgr[maxdic] = new HashMgr(dpath, affixpath, key, dpathIsData, mapathIsData);
//BeQt patch end ------------------------------------------------------------------------------------------------------
